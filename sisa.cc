...
{
    if (n == 0)
        vector[i] = '0', vector[i - 1] = '0', vector[i - 2] = '0', vector[i - 3] = '0';
    else if (n == 1)
        vector[i] = '0', vector[i - 1] = '0', vector[i - 2] = '0', vector[i - 3] = '1';
    else if (n == 2)
        vector[i] = '0', vector[i - 1] = '0', vector[i - 2] = '1', vector[i - 3] = '0';
    else if (n == 3)
        vector[i] = '0', vector[i - 1] = '0', vector[i - 2] = '1', vector[i - 3] = '1';
    else if (n == 4)
        vector[i] = '0', vector[i - 1] = '1', vector[i - 2] = '0', vector[i - 3] = '0';
    else if (n == 5)
        vector[i] = '0', vector[i - 1] = '1', vector[i - 2] = '0', vector[i - 3] = '1';
    else if (n == 6)
        vector[i] = '0', vector[i - 1] = '1', vector[i - 2] = '1', vector[i - 3] = '0';
    else if (n == 7)
        vector[i] = '0', vector[i - 1] = '1', vector[i - 2] = '1', vector[i - 3] = '1';
    else if (n == 8)
        vector[i] = '1', vector[i - 1] = '0', vector[i - 2] = '0', vector[i - 3] = '0';
    else if (n == 9)
        vector[i] = '1', vector[i - 1] = '0', vector[i - 2] = '0', vector[i - 3] = '1';
    else if (n == 10)
        vector[i] = '1', vector[i - 1] = '0', vector[i - 2] = '1', vector[i - 3] = '0';
    else if (n == 11)
        vector[i] = '1', vector[i - 1] = '0', vector[i - 2] = '1', vector[i - 3] = '1';
    else if (n == 12)
        vector[i] = '1', vector[i - 1] = '1', vector[i - 2] = '0', vector[i - 3] = '0';
    else if (n == 13)
        vector[i] = '1', vector[i - 1] = '1', vector[i - 2] = '0', vector[i - 3] = '1';
    else if (n == 14)
        vector[i] = '1', vector[i - 1] = '1', vector[i - 2] = '1', vector[i - 3] = '0';
    else if (n == 15)
        vector[i] = '1', vector[i - 1] = '1', vector[i - 2] = '1', vector[i - 3] = '1';
}*/

/*
void to_vector(vector<int>& vector, int n, int i)
{
    if (n == 0)
        vector[i] = 0, vector[i - 1] = 0, vector[i - 2] = 0, vector[i - 3] = 0;
    else if (n == 1)
